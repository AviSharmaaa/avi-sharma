 ...
 * Original Author: zoyron
 * Source: https://github.com/zoyron/sketches/blob/main/src/data/sketches/FluidSimulation.tsx
 * 
 * Adapted for this portfolio with React Three Fiber.
 */
